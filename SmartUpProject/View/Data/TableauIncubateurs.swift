...
var incubateurs : [LesIncubateurs] = [
    ...
    LesIncubateurs(nom: "Incubateur Impulse", adresse1: "Maison du développement industriel", adresse2: "technopole de Chateau Gombert", adresse3: "", codePostal: "13452", ville: "Marseille", telephone: "0491100145", mail: "contact@incubateur-impulse.com", siteWeb: "incubateur-impulse.fr", spécialité: "science et technologie",gps: CLLocationCoordinate2D(latitude: 43.343151, longitude: 5.438428)),
...
// pourquoi avoir créer cette variable ici pour l'appeler dans le fichier IncubateurView ???? Réponse : pour pouvoir l'appeller dans la liste avec la même mise en forme que dans IncubateurVIew...
